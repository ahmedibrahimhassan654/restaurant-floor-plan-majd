...
var Toolbar = function Toolbar(_ref3, context) {
  ...
  // var urlParams = new URLSearchParams(window.location.search); // Commented out or removed
  // var restaurant = urlParams.get("restaurant"); // Commented out or removed
  var restaurant = "4"; // Set restaurant_id statically to 4
