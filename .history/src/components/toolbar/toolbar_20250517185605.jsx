import React, { useContext, useEffect, useState, useRef } from "react"; // Consolidated imports
...
const Toolbar = (
  ...
  const { projectActions, viewer3DActions, translator } = context; // Keep this declaration
  ...
  // Removed duplicate: const { projectActions, translator } = context;
  ...
  var restaurant = "7"; // Here the restaurant_id is statically set to "4"
