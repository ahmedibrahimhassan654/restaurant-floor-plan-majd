    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { style: itemsStyle },
          this.state.matchString === "" ? [turnBackButton,
          ...
          elementsToDisplay.map(function (elem) {
            return (
              // elem.name == "sedia" ||
              // elem.name == "table" ||
              // elem.name == "one_cher_s" ||
              // elem.name == "onetableradus" ||

              // elem.name == "tableFour" ||
              // elem.name == "onetable" ||
              elem.name == "table-with-eight" || elem.name == "table-with-one" || elem.name == "tow-char" || elem.name == "table-with-four" ? _react2.default.createElement(_catalogItem2.default, { key: elem.name, element: elem }) : null
            );
          }
